    ...
    private Point captureViewImpl(@NonNull final View view, @NonNull final OutputStream os) {
        ...
        for (final View child : childrenList) {
            ...
            if (child instanceof TextureView) {
                ...
                final Bitmap svBitmap = getExactBitmapForScreenshot(svChild.getWidth(), svChild.getHeight());

                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    try {
                        PixelCopy.request(svChild, svBitmap, new PixelCopy.OnPixelCopyFinishedListener() {
                        ...
                        c.drawBitmap(svBitmap, svChild.getLeft(), svChild.getTop(), paint);
                        recycleBitmap(svBitmap);
                    } catch (Exception e) {
